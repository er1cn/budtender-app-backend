...
U1=User.create!(username:'pumpkins', password: 'ftTv7AJU')
U2=User.create!(username:'rosecocoa', password: 'vPSJLm2T')
U3=User.create!(username:'heatham', password: 'kEpdd39T')
U4=User.create!(username:'golfbeach', password: '5oE9ipFE')
U5=User.create!(username:'grapeswan', password: 'iPWkD44E')
U6=User.create!(username:'sodarocky', password: 'Lwku3kvi')
U7=User.create!(username:'sheeprat', password: 'uetJy9Wr')
U8=User.create!(username:'cheetah', password: '8okBKusx')
U9=User.create!(username:'lizardcat', password: 'intm7BcQ')
U10=User.create!(username:'relishcat', password: '5F4DkueG')

r1=Review.create!(description: 'impressed me on multiple levels.', rating: 5)
r2=Review.create!(description: 'Really good. I would gladly pay over.', rating: 5)
r3=Review.create!(description: 'Fantastic, totally blown away.', rating: 4.5)
r4=Review.create!(description: 'Strain is killer.', rating: 4)
r5=Review.create!(description: 'Dude, this stuff is the bomb.', rating: 4.5)
r6=Review.create!(description: 'Very calming.', rating: 4)
r7=Review.create!(description: 'has got everything I need.', rating: 5)
r8=Review.create!(description: 'awesome!', rating: 5)
r9=Review.create!(description: 'completely blown away.', rating: 4.5)
r10=Review.create!(description: 'The best one the net!', rating: 3.5)
